package com.whisky.yupicturebackend.manager.auth;
...
import static com.whisky.yupicturebackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    private SpaceUserAuthContext getAuthContextByRequest() {
        ...
        String contentType = request.getHeader(Header.CONTENT_TYPE.getValue()); // 请求类型
