package com.whisky.yupicturebackend.manager.websocket;
...
import com.whisky.yupicturebackend.manager.websocket.disruptor.PictureEditEventProducer;
import com.whisky.yupicturebackend.manager.websocket.model.PictureEditActionEnum;
import com.whisky.yupicturebackend.manager.websocket.model.PictureEditMessageTypeEnum;
import com.whisky.yupicturebackend.manager.websocket.model.PictureEditRequestMessage;
import com.whisky.yupicturebackend.manager.websocket.model.PictureEditResponseMessage;
...
public class PictureEditHandler extends TextWebSocketHandler {
    ...
    protected void handleTextMessage(WebSocketSession session, TextMessage message) throws Exception {
        ...
        PictureEditRequestMessage pictureEditRequestMessage = JSONUtil.toBean(
                message.getPayload(), // payload data是 websocket 存放真正要传输的数据的字段
