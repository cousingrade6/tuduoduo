...
import com.whisky.yupicturebackend.config.CosClientConfig;
...
public class FileManager {
    ...
    private static final List<String> ALLOW_FORMAT_LIST = Arrays.asList("jpeg", "png", "jpg", "webp", "jfif");
    ...
    @Autowired
    public FileManager(CosClientConfig cosClientConfig, CosManager cosManager) {
    ...
    private void validPicture(MultipartFile multipartFile) {
        ...
        ThrowUtils.throwIf(fileSize > 2 * _1M, ErrorCode.PARAMS_ERROR, "文件大小不能超过 2MB");
        // 2. 校验文件后缀
