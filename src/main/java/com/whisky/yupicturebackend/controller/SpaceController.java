...
import com.whisky.yupicturebackend.model.dto.space.*;
...
public class SpaceController {
    ...
    @Autowired
    public SpaceController(UserService userService, SpaceService spaceService, SpaceUserAuthManager spaceUserAuthManager) {
